...
ln -s $PWD/UniversalModCore/src/main/resources/fabric.mod.json src/main/resources/fabric.mod.json
ln -s $PWD/UniversalModCore/src/main/resources/modcore.main-mixins.json src/main/resources/modcore.main-mixins.json
