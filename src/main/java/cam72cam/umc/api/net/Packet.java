...
public abstract class Packet {
    private static final SimpleNetworkWrapper net = NetworkRegistry.INSTANCE.newSimpleChannel("cam72cam.umc.api");
    ...
    public static class Message implements IMessage {
        ...
        public void fromBytes(ByteBuf buf) {
            ...
            String cls = data.getString("cam72cam.umc.api.pktid");
        ...
        public void toBytes(ByteBuf buf) {
            ...
            data.setString("cam72cam.umc.api.pktid", packet.getClass().toString());
            try {
