package cam72cam.umc.api.resource;
...
class Data {
    @SidedProxy(clientSide = "cam72cam.umc.api.resource.Data$ClientProxy", serverSide = "cam72cam.umc.api.resource.Data$ServerProxy", modId = ModCore.MODID)
