...
@net.minecraftforge.fml.common.Mod(modid = ModCore.MODID, name = ModCore.NAME, version = ModCore.VERSION, acceptedMinecraftVersions = "[1.10,1.11)", dependencies = "required-after:mixinbooter@[10.7,11.0),[11.5,12.0)")
