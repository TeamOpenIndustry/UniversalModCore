        ...
        return data -> {
            ...
            net.minecraft.client.particle.Particle p = new net.minecraft.client.particle.Particle(data.world.internal, data.pos.x, data.pos.y, data.pos.z, data.motion.x, data.motion.y, data.motion.z) {
                ...
                public void buildGeometry(BufferBuilder buffer, Camera entityIn, float partialTicks, float rotationX, float rotationZ, float rotationYZ, float rotationXY, float rotationXZ) {
                    ip.ticks = age;
                    ip.renderX = x - cameraX + this.velocityX * partialTicks;
                    ip.renderY = y - cameraY + this.velocityY * partialTicks;
                    ip.renderZ = z - cameraZ + this.velocityZ * partialTicks;
            ...
            net.minecraft.client.MinecraftClient.getInstance().particleManager.addParticle(p);
        };
    }
