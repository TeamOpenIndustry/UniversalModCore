    ...
    public static With apply(RenderState state) {
        ...
        if (state.lightmap != null) {
            ...
            if (vanillaEmissive) {
                ...
                GL13.glActiveTexture(GLX.GL_TEXTURE1);
                ...
                int x = i % 65536;
                int y = i / 65536;
                float oldX = GLX.lastBrightnessX;
                float oldY = GLX.lastBrightnessY;
                GLX.glMultiTexCoord2f(GLX.GL_TEXTURE1, x, y);
                restore.add(() -> GLX.glMultiTexCoord2f(GLX.GL_TEXTURE1, oldX, oldY));
            }
        }

        if (state.texture != null) {
            GL13.glActiveTexture(GLX.GL_TEXTURE0);
            boolean oldTexEnabled = GL11.glGetBoolean(GL11.GL_TEXTURE_2D);
        ...
        if (state.color != null) {
            ...
            GL11.glGetFloatv(GL11.GL_CURRENT_COLOR, fourFloatBuffer);
