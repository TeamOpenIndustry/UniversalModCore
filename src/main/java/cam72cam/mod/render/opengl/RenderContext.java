    ...
    public static With apply(RenderState state) {
        ...
        if (state.lightmap != null) {
            ...
            if (vanillaEmissive) {
                ...
                GlStateManager._glMultiTexCoord2f(GL13.GL_TEXTURE1, x, y);
                restore.add(() -> GlStateManager._glMultiTexCoord2f(GL13.GL_TEXTURE1, oldX, oldY));
            }
        }
        ...
        if (state.color != null) {
            ...
            if (fourFloatBuffer == null) {
                fourFloatBuffer = GLAllocation.createFloatBuffer(16);
            }
