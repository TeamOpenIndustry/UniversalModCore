...
public class Light {
    ...
    private void init(net.minecraft.world.World world, net.minecraft.util.math.Vec3d pos, double lightLevel) {
        ...
        internal.setPosition(pos.xCoord, pos.yCoord, pos.zCoord);
    ...
    public static void register() {
        CommonEvents.Entity.REGISTER.subscribe(() -> {
            net.minecraftforge.fml.common.registry.EntityRegistry.registerModEntity(LightEntity1.class, "light1", -1, ModCore.instance, 0, 0, false);
            net.minecraftforge.fml.common.registry.EntityRegistry.registerModEntity(LightEntity2.class, "light2", -1, ModCore.instance, 0, 0, false);
            net.minecraftforge.fml.common.registry.EntityRegistry.registerModEntity(LightEntity3.class, "light3", -1, ModCore.instance, 0, 0, false);
            net.minecraftforge.fml.common.registry.EntityRegistry.registerModEntity(LightEntity4.class, "light4", -1, ModCore.instance, 0, 0, false);
            net.minecraftforge.fml.common.registry.EntityRegistry.registerModEntity(LightEntity5.class, "light5", -1, ModCore.instance, 0, 0, false);
            net.minecraftforge.fml.common.registry.EntityRegistry.registerModEntity(LightEntity6.class, "light6", -1, ModCore.instance, 0, 0, false);
            net.minecraftforge.fml.common.registry.EntityRegistry.registerModEntity(LightEntity7.class, "light7", -1, ModCore.instance, 0, 0, false);
            net.minecraftforge.fml.common.registry.EntityRegistry.registerModEntity(LightEntity8.class, "light8", -1, ModCore.instance, 0, 0, false);
            net.minecraftforge.fml.common.registry.EntityRegistry.registerModEntity(LightEntity9.class, "light9", -1, ModCore.instance, 0, 0, false);
            net.minecraftforge.fml.common.registry.EntityRegistry.registerModEntity(LightEntity10.class, "light10", -1, ModCore.instance, 0, 0, false);
            net.minecraftforge.fml.common.registry.EntityRegistry.registerModEntity(LightEntity11.class, "light11", -1, ModCore.instance, 0, 0, false);
            net.minecraftforge.fml.common.registry.EntityRegistry.registerModEntity(LightEntity12.class, "light12", -1, ModCore.instance, 0, 0, false);
            net.minecraftforge.fml.common.registry.EntityRegistry.registerModEntity(LightEntity13.class, "light13", -1, ModCore.instance, 0, 0, false);
            net.minecraftforge.fml.common.registry.EntityRegistry.registerModEntity(LightEntity14.class, "light14", -1, ModCore.instance, 0, 0, false);
            net.minecraftforge.fml.common.registry.EntityRegistry.registerModEntity(LightEntity15.class, "light15", -1, ModCore.instance, 0, 0, false);
        });
    }
