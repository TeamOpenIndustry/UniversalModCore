...
class ClientSound extends AbstractSoundInstance implements TickableSoundInstance, ISound {
    ...
    private final WeighedSoundEvents accessor;
    ...
    protected ClientSound(ResourceLocation soundId, SoundCategory categoryIn, boolean repeats, float attenuationDistance, float scale) {
        super(soundId, categoryIn.category, Minecraft.getInstance().font.random);
        this.volume = 1;
        this.pitch = 1;
        ...
        this.accessor = new WeighedSoundEvents(soundId, null); // TODO translation
