...
public class TagCompound {
    ...
    public <T extends BlockEntity> T getTile(String key, boolean isClient) {
        return getter(key, () -> {
            ...
            net.minecraft.world.level.block.entity.BlockEntity te = net.minecraft.world.level.block.entity.BlockEntity.loadStatic(blockpos, null, ted.get("data").internal, world.internal.registryAccess());
