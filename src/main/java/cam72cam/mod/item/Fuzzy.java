...
public class Fuzzy {
    ...
    public static final Fuzzy STEEL_INGOT = new Fuzzy(ItemTags.create(ResourceLocation.tryBuild("forge", "ingots/steel")), "ingotSteel");
    public static final Fuzzy STEEL_BLOCK = new Fuzzy(ItemTags.create(ResourceLocation.tryBuild("forge", "storage_blocks/steel")), "blockSteel");
