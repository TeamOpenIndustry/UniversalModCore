...
public enum Material {
    ...
    DIRT(net.minecraft.block.material.Material.DIRT, SoundType.),
    ...
    LEAF(net.minecraft.block.material.Material.LEAVES, SoundType.),
    PLANT(net.minecraft.block.material.Material.PLANT, SoundType.PLANT),
    VINE(net.minecraft.block.material.Material.PLANT, SoundType.PLANT),
